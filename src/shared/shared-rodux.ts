...
export namespace SharedRodux {
  ...
  export namespace Actions {
    export type Allocate = Rodux.Action<"Allocate"> & {
      key: string;
      state?: AllocatedRodux.AllocatedState;
    };
  ...
  export const OwnershipMap: {
    [a in SharedRodux.SharedActions["type"]]: keyof SharedRodux.SharedState | "none";
  } = {
  ...
  export const DefaultSharedState: SharedState = {
    ...
    AllocatedData: {
      value: new Map<string, AllocatedRodux.AllocatedState>(),
      Ownership: [],
    },
    RestrictedData: {
      value: new Map<string, RestrictedRodux.RestrictedState>(),
      Ownership: [],
    },
  };
  ...
  export const SharedReducer = Rodux.createReducer<SharedState, SharedActions>(DefaultSharedState, {
    ...
    Allocate: (s, a) => {
      ...
      if (g.AllocatedData.value.get(a.key) === undefined && g.RestrictedData.value.get(a.key) === undefined) {
        g.AllocatedData.value.set(a.key, a.state !== undefined ? a.state : { ...AllocatedRodux.DefaultAllocatedState });
